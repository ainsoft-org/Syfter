...
exports.getNeighs = void 0;
function getNeighs(dataFrame, userId, k = 5) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        let sum2 = 0;
        let sum3 = 0;
        for (let f = 0; f < forUser.reactions.length; f++) {
...
exports.getNeighs = getNeighs;
//# sourceMappingURL=getNeighs.js.map